...
| Image inspection | `inspect_images`, `vision_review`, canonical image blocks, structured image attachments | Image inspection is instruction-driven and read-only; provider adapters own wire conversion, and ACP attachment calls share permission negotiation, bounded model context, and usage accounting. | Pending PR #62; replaces the model-facing `vision_review` contract. | [PR #62](#2026-08-21--instruction-driven-image-inspection-pr-62) |
...
- Change: [PR #62, `feat(tools): add instruction-driven image inspection`](https://github.com/Raccoon-Office/Box-Agent/pull/62), implementation `852f39ec0853b9f9e3e9b72a1e5ff877ffd2ad78`.
