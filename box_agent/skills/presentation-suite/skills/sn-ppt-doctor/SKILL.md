---
name: sn-ppt-doctor
description: Use when diagnosing PPT Skill setup or failures involving source parsing, Playwright or Chromium rendering, HTML-to-PPTX export, dynamic HTML rendering, or bundled search and image-tool configuration.
metadata:
