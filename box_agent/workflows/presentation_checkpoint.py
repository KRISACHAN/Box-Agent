        ...
        if stale_revalidation is not None:
            ...
            direct_read_instruction = (
                ...
                if direct_research_read_complete
                    ...
                    "consecutive reads yield no usable source content. For managed "
                    "browser automation, activate the exact managed_browser_navigate "
                    "and managed_browser_snapshot tool names together, then process "
                    "one URL at a time as managed_browser_navigate(url) followed by "
            ...
            next_action = (
                ...
                "use managed_browser_navigate followed by managed_browser_snapshot for "
                "independent public-web reads. Use user_browser_* when the read depends "
